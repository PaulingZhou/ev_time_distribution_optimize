function [ charge_start_dist_4hour,charge_cost_amount,charge_cost_base,charge_cost_equip ] = get_charge_dist( demand_time_dist )
%get_charge_dist
...
[ charge_start_plan_battery, charge_start_plan_power ] = get_charge_start_plan(demand_time_dist);
...
max_power = max(charge_start_plan_power);
charge_cost_base = fcb*max_power;
